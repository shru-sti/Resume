const profileData = {
  ...
  languages: [
    {
      title: "Languages",
      value: "English, Kannada, Hindi,Malayalam,Tamil, Tulu,Telugu ,Beary , Konkani",
    },],
  skills: [
    {
      title: "Languages",
      value: "HTML, CSS, JavaScript , C , C++ , Python , Java ,",
    },
    {
      title: "Frameworks/Libraries",
      value: "ReactJS, React-Native, Redux, NodeJS-Express, Angular",
    },
    {
      title: "Others",
      value: "Git, AWS",
  ...
  education: [
    {
      alma: "Sheshadripuram First Grade College , Bangalore ",
      duration: "2021 - 2023",
      std: "B.C.A",
      score: "82.00%",
    },
    {
      alma: "St. Agnes , Mangalore",
      duration: "2018 - 2020",
      std: "Class XI-XII ()",
      score: "89.80%",
    },
